function submitContact() {
  if ($('#bookmark-form').valid()) {
    ...
    var tablist =
      '	<a class="contact-tab-' +
      index_var +
      ' nav-link active" id="v-pills-user-tab" data-bs-toggle="pill" onclick="activeDiv(' +
      index_var +
    ...
    var tabcontent =
      ...
      '</p>\
		                      <ul>\
		                        <li><a href="javascript:void(0)" onclick="editContact(' +
      index_var +
      ')" data-original-title="" title="">Edit</a></li>\
		                        <li><a href="javascript:void(0)" onclick="deleteContact(' +
      index_var +
      ')" data-original-title="" title="">Delete</a></li>\
		                        <li><a href="javascript:void(0)" onclick="history(' +
      index_var +
      ')" data-original-title="" title="">History</a></li>\
		                        <li><a href="javascript:void(0)" onclick="printContact(' +
      index_var +
      ')" data-bs-toggle="modal" data-bs-target="#printModal" data-original-title="" title="">Print</a></li>\
		                      </ul>\
		                    </div>\
		                  </div>\
    ...
    var notify = $.notify('Application added successfully.', {
      type: 'contactadd',
      allow_dismiss: false,
      delay: 2000,
      placement: {
