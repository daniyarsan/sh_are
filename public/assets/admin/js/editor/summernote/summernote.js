...
(function (global, factory) {
   ...
   * @param {enum} where  Where change will be applied PaymentTableRow or Col. Use enum: TableResultAction.where
  ...
  var TableResultAction = function (startPoint, where, action, domTable) {
    ...
    function setStartPoint() {
      ...
      if (
        ...
        console.error(
          'Impossible to identify start PaymentTableRow point.',
          startPoint,
        );
        return;
      }
     ...
     *
     * @param {int} rowIndex Home position in line of virtual table.
     * @param {int} cellIndex Home position in column of virtual table.
     * @param {object} baseRow PaymentTableRow affected by this position.
     ...
     *
     * @param {int} rowIndex Home of row to find free space.
     * @param {int} cellIndex Home of cell to find free space in table.
     */
     ...
     *
     * @param {object} row PaymentTableRow to recover information.
    ...
    function addCellInfoToVirtual(row, cell) {
      ...
      // Add span rows to virtual PaymentTable.
