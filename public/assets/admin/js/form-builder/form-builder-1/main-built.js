        ...
        return e.JSON && e.JSON.parse
          ...
          : null === n
            ...
            : 'string' == typeof n &&
                ((n = ut.trim(n)),
                n &&
                  pt.test(n.replace(vt, '@').replace(mt, ']').replace(dt, '')))
              ? Function('return ' + n)()
        ...
        return (
          ...
          i(function (i, o, u, a) {
            ...
            if (i) {
              ...
              (y = v(y === o ? y.splice(d, y.length) : y)),
                s ? s(null, o, y, a) : G.apply(o, y);
          })
        );
      }
      ...
      _default: {
        ...
        set: function (e) {
          ut.fx.step[e.prop]
            ? ut.fx.step[e.prop](e)
            : e.elem.style &&
                (null != e.elem.style[ut.cssProps[e.prop]] ||
                  ut.cssHooks[e.prop])
