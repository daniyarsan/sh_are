        ...
        b.define('select2/compat/initSelection', ['jquery'], function (a) {
          function b(a, b, c) {
            c.get('debug') &&
              ...
              console.warn &&
              console.warn(
                'Select2: The `initSelection` option has been deprecated in favor of a custom data adapter that overrides the `current` method. This method is now called multiple times instead of a single time when the instance is initialized. Investment will be removed for the `initSelection` option in future versions of Select2',
              ),
        ...
        b.define('select2/compat/query', [], function () {
          function a(a, b, c) {
            c.get('debug') &&
              ...
              console.warn &&
              console.warn(
                'Select2: The `query` option has been deprecated in favor of a custom data adapter that overrides the `query` method. Investment will be removed for the `query` option in future versions of Select2.',
              ),
              a.call(this, b, c);
          }
          return (
