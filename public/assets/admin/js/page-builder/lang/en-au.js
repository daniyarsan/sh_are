...
CKEDITOR.lang['en-au'] = {
  ...
  table: {
    ...
    columns: 'Columns',
    deleteTable: 'Delete PaymentTable',
    headers: 'Headers',
    headersBoth: 'Both',
    headersColumn: 'First column',
    headersNone: 'None',
    headersRow: 'First PaymentTableRow',
    ...
    invalidHeight: 'PaymentTable height must be a number.',
    invalidRows: 'Number of rows must be a number greater than 0.',
    invalidWidth: 'PaymentTable width must be a number.',
    menu: 'PaymentTable Properties',
    row: {
      menu: 'Row',
      insertBefore: 'Insert PaymentTableRow Before',
      insertAfter: 'Insert PaymentTableRow After',
      deleteRow: 'Delete Rows',
    },
    rows: 'Rows',
    summary: 'Summary',
    title: 'PaymentTable Properties',
    toolbar: 'Table',
    widthPc: 'percent',
    widthPx: 'pixels',
