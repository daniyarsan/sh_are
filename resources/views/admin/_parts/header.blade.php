...
<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="{{route('admin.index')}}"><img style="width: 40px" class="img-fluid" src="{{Vite::image('logo/logo.png')}}" alt=""></a></div>
            <div class="dark-logo-wrapper"><a href="{{route('admin.index')}}"><img class="img-fluid" src="{{Vite::image('logo/logo.png')}}" alt=""></a></div>
