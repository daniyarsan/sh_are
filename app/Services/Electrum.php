...
class Electrum {
     ...
     * @return void
     */
    public function __construct(string $rpcuser, string $rpcpass, string $rpchost = "localhost", int $rpcport = 7000) {
     ...
     */
    public function history(int $min_confirmations = 1, int $from_height = 1, $last_height = false) : array {
        $result = [];
